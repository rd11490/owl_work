class Teams:
    ...
    East = [Hunters, Charge, Spark, Valiant, Fusion, Dynasty, Dragons]
    West = [Reign, Uprising, Fuel, Mayhem, Outlaws, Spitfire, Gladiators, Eternal, Shock, Defiant, Titans, Justice, Excelsior]
